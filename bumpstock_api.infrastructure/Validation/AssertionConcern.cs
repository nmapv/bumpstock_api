...
namespace bumpstock_api.infrastructure.Validation
{
    public class AssertionConcern
    {
        ...
        protected void SelfAssertArgumentRange(DateTime value, DateTime minimum, DateTime maximum, string message)
        {
            AssertionConcern.AssertArgumentRange(value, minimum, maximum, message);
        }
